...
class LoginPageSellerView extends ConsumerStatefulWidget {
  const LoginPageSellerView({super.key});

  @override
  ConsumerState<LoginPageSellerView> createState() => _LoginPageViewState();
}

class _LoginPageViewState extends ConsumerState<LoginPageSellerView> {
  ...
  Widget build(BuildContext context) {
    final authStateSeller = ref.watch(authViewModelSellerProvider);
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (authStateSeller.showMessage! && authStateSeller.error != null) {
